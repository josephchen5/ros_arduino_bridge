#ifndef Sabertooth2x25A_h
#define Sabertooth2x25A_h

#include <Arduino.h>

class Sabertooth2x25A
{
  public:  
    // CONSTRUCTORS
    Sabertooth2x25A(); // Default pin selection.
    Sabertooth2x25A(unsigned char INA1, unsigned char INB1, 
